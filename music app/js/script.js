...
const songs = [
  ...
  "MATRANG - Медуза",
  "Pitbull - Hotel Room",
  "Raikaho - Letit Patrul",
  "Roy Jones Jr. - Can't Be Touched",
  "Крид & The Limba - Coco L'eau",
];
...
function updateProgress(e) {
  ...
  startTime.innerHTML = `${roundTime}:${
    lastRoundTime < 10 ? "0" + lastRoundTime : lastRoundTime
  }`;
  endTime.innerHTML = `${Math.floor(duration / 60)}:${Math.floor(
    duration % 60
  )}`;
